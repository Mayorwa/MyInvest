                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{URL::asset('destinations/owerri.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{URL::asset('destinations/Ibadan.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{URL::asset('destinations/ogun.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{URL::asset('destinations/lagos.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{URL::asset('destinations/abujae.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{URL::asset('destinations/enugu.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{URL::asset('destinations/abuja.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="partners-slider">
                                                        ...
                                                        <div class="partner-item text-center">
                                                            <div class="partner-thumb">
                                                                ...
                                                                <img width="285" height="160" src="{{URL::asset('partners/paystack.png')}}" class="img-responsive wp-post-image" alt="" />                                    <!-- </a> -->
                                                            </div>
                                                        </div>
                                                        <div class="partner-item text-center">
                                                            <div class="partner-thumb">
                                                                <!-- <a href="https://homeywp.com"> -->
                                                                <img width="285" height="160" src="{{URL::asset('partners/realtypro.png')}}" class="img-responsive wp-post-image" alt="" />                                    <!-- </a> -->
                                                            </div>
                                                        </div>
