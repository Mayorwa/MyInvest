                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{secure_asset('public/destinations/owerri.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{secure_asset('public/destinations/Ibadan.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{secure_asset('public/destinations/ogun.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{secure_asset('public/destinations/lagos.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{secure_asset('public/destinations/abujae.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{secure_asset('public/destinations/enugu.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="taxonomy-item taxonomy-card">
                                                        <a class="taxonomy-link hover-effect">
                                                            ...
                                                            <img class="img-responsive" src="{{secure_asset('public/destinations/abuja.jpg')}}" width="555" height="360" alt="listing_city">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="partners-slider">
                                                        ...
                                                        <div class="partner-item text-center">
                                                            <div class="partner-thumb">
                                                                ...
                                                                <img width="285" height="160" src="{{secure_asset('public/partners/paystack.png')}}" class="img-responsive wp-post-image" alt="" />                                    <!-- </a> -->
                                                            </div>
                                                        </div>
                                                        <div class="partner-item text-center">
                                                            <div class="partner-thumb">
                                                                <!-- <a href="https://homeywp.com"> -->
                                                                <img width="285" height="160" src="{{secure_asset('public/partners/realtypro.png')}}" class="img-responsive wp-post-image" alt="" />                                    <!-- </a> -->
                                                            </div>
                                                        </div>
