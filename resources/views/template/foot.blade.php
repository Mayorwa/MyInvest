<script type='text/javascript' src='{{URL::asset('js/bootstrap.min7433.js')}}'></script>
<script type='text/javascript' src='{{URL::asset('js/homey-ajax6f3e.js')}}'></script>
<script type='text/javascript' src='{{URL::asset('js/custom6f3e.js')}}'></script>
<script type='text/javascript' src='{{URL::asset('js/skrollr.min5b21.js')}}'></script>
<script>
