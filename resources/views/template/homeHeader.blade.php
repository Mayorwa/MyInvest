                ...
                <div class="header-comp-logo">
                    <h1>
                        <a class="homey_logo" href="{{URL('/')}}">
                            <img src="{{secure_asset('public/logos/light.png')}}" alt="MYYINVEST" title="MYYINVEST">
                        </a>
                    </h1>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <div class="mobile-logo text-center">
                            <h1>
                                <a href="{{URL('/')}}">
                                    <img src="{{secure_asset('public/logos/icon-light.png')}}" alt="MYYINVEST" title="MYYINVEST">
                                </a>
                            </h1>
                        </div><!-- mobile-logo -->
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="user-nav-wrap">
                    <nav id="user-nav" class="nav-dropdown main-nav-dropdown collapse navbar-collapse mobile">
                        @if($usr !== null)
                            @if($usr->type !== "company")
                                <ul class="login-register list-inline">
