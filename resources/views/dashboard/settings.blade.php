                        ...
                        <div class="kt-form kt-form--label-right">
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <form action="{{ URL('company/editInfo') }}" method="POST">
                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                                        <input type="hidden" name="slug" value="{{$usr->slug}}">
                                        <input type="hidden" name="companySlug" value="{{$usr->company->slug}}">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input type="text" class="form-control" name="companyAddress" placeholder="Company Address" aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                            <div class="form-group row">
