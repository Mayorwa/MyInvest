                ...
                <div class="kt-widget kt-widget--user-profile-2">
                    <div class="kt-widget__head">
                        <div class="kt-widget__media">
                            <img class="kt-widget__img kt-hidden-" src="{{secure_asset('public/assets/img/company.png')}}" alt="image">
                    ...
                    <div class="kt-widget__body">
                        <div class="kt-widget__item">
                            <div class="kt-widget__contact">
                                ...
                                <a href="#" class="kt-widget__data">{{$usr->company->email}}</a>
                            </div>
                            <div class="kt-widget__contact">
                            ...
                            <div class="kt-widget__contact">
                                <span class="kt-widget__label">Company Address:</span>
                                <span class="kt-widget__data">{{$usr->company->address}}</span>
                            </div>
                            <div class="kt-widget__contact">
                            ...
                            @if($usr->company->accountNumber !== null)
                                <div class="kt-widget__contact">
                                    <span class="kt-widget__label">Account Number:</span>
                                    <a href="#" class="kt-widget__data">{{$usr->company->accountNumber}}</a>
                                </div>
                            @else
                                <div class="kt-widget__contact">
                                    <span class="kt-widget__label">Account Number:</span>
