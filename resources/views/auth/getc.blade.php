...
<head>
    ...
    <link href="{{URL::asset('assets/css/custom-may.css')}}" rel="stylesheet" type="text/css" />
    <!-- END Custom CSS-->
</head>
<style>
    .btn-dhsco-col{
                    ...
                    <div class="col-md-4 col-10 box-shadow-2 p-0">
                            ...
                            <div class="card-header border-0">
                                <div class="card-title text-center">
                                    <a href="{{URL('/')}}" class="p-1">
                                        <img src="{{URL::asset('logos/dark.png')}}" alt="MyyInvest Logo" width="200px" class="img-responsive">
                                    </a>
                                </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form-horizontal form-simple" action="{{URL('auth/get-access')}}" method="POST" id="getAccessForm" novalidate>
                                        ...
                                        <br>
                                        <center><img id="loaderImg" src="{{URL::asset('assets/images/loader.gif')}}" width="35px" class="img-responsive"/></center>
                        ...
                        <div class="card border-grey border-lighten-3 m-0" id="confirmAccess">
                            <div class="card-header border-0">
                                <div class="card-title text-center">
                                    <a href="{{URL('/')}}" class="p-1">
                                        <img src="{{URL::asset('logos/dark.png')}}" alt="MyyCrib logo" width="200px" class="img-responsive">
                                    </a>
                                </div>
                                <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
...
<script src="{{URL::asset('assets/vendors/js/ui/headroom.min.js')}}" type="text/javascript"></script>
<script src="{{URL::asset('assets/js/scripts/custom.js')}}" type="text/javascript"></script>

<script src="{{URL::asset('assets/js/modules/auth.js')}}"></script>
<script>
...
<script src="{{URL::asset('assets/js/scripts/forms/form-login-register.js')}}"></script>
<script src="{{URL::asset('assets/vendors/js/ui/headroom.min.js')}}"></script>
