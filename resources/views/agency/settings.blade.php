                        ...
                        <div class="kt-form__body">
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    ...
                                    <form action="{{ URL('agency/editInfo') }}" method="POST">

                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                                        <input type="hidden" name="slug" value="{{$usr->slug}}">
                                        <input type="hidden" name="agencySlug" value="{{$usr->agency->slug}}">
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">Full Name</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <input name="name" class="form-control" type="text" placeholder="John Doe" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" placeholder="08100000000" aria-describedby="basic-addon1" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="address" class="form-control" placeholder="34 Drtshjs, JJJJDJJS" aria-describedby="basic-addon1" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" pattern="\d*" maxlength="10" minlength="10" name="accountNumber" class="form-control" title="Enter Numbers Only" placeholder="0100001001" aria-describedby="basic-addon1" required>
                                                </div>
                                            </div>
                                        </div>
